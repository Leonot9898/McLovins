...
function scrollFunction() {
  ...
  function change_CBM(){
    ...
    if (SS.getAttribute('href') == '../css/McLovins_CBM.css') {
                SS.setAttribute('href', '../css/McLovins.css');
            } 
    else if(SS.getAttribute('href') == '../css/McLovins.css') {
                SS.setAttribute('href', '../css/McLovins_CBM.css');
            } 
}
